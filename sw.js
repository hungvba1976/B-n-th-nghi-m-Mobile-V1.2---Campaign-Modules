const APP_CACHE = "luyenthi-v12-app-v1.2.4-intro1";
const BANK_CACHE = "luyenthi-v12-bank-releases";
const CAMPAIGN_CACHE = "luyenthi-v12-campaign-modules";
const APP_ASSETS = [
  "./","./index.html","./styles.css","./app.js","./manifest.webmanifest",
  "./icon-192.png","./icon-512.png","./donate-qr.png"
];
const BASELINE_BANK_ASSETS = [
  "./release/latest.json","./release/2026.08.1/manifest.json","./release/2026.08.1/banks.json"
];
const CAMPAIGN_ASSETS = [
  "./campaigns/catalog.json",
  "./campaigns/demo-chuyen-doi-so-2026/module.json","./campaigns/demo-chuyen-doi-so-2026/questions.json",
  "./campaigns/demo-van-hoa-agribank-2026/module.json","./campaigns/demo-van-hoa-agribank-2026/questions.json"
];
...
self.addEventListener("activate", event => {
  event.waitUntil(caches.keys().then(keys => Promise.all(
    keys.filter(k => k.startsWith("luyenthi-v12-app-") && k !== APP_CACHE).map(k => caches.delete(k))
  )));
  self.clients.claim();
});
